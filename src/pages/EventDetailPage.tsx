        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center lg:justify-start mb-4">
                    <div className="bg-blue-500 text-white px-4 py-2 border-2 btn font-bold hover:scale-105 transition-transform duration-200">
                      {event.date}
                    </div>
                    <div className="bg-green-500 text-white px-4 py-2 border-2 btn font-bold hover:scale-105 transition-transform duration-200">
                      {event.location}
                    </div>
          ...
          <div className="space-y-6">
            <div className={`bg-white card-bold p-4 transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{ transitionDelay: '300ms' }}>
              <div className="bg-green-500 card inline-block px-4 py-2 mb-4 hover:scale-105 transition-transform duration-200">
