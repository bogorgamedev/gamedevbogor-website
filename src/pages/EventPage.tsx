...
const EventsPage = () => {
  ...
  const [isVisible, setIsVisible] = useState(false); // State untuk kontrol animasi

  // Efek untuk animasi transisi ketika komponen dimuat
  useEffect(() => {
    // Timer kecil untuk memastikan DOM sudah siap
  ...
  return (
    ...
    style={{backgroundColor : "#30339b"}}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className={`mb-16 transition-all duration-800 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        ...
        <section className={`transition-all duration-800 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
